...
The browser regression tagged `@claim:demo-isolation` proves the namespace boundary. `@claim:offline-demo` owns a fresh browser context and proves the installed demo reloads while offline.
